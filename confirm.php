...
<link href="https://steamstore-a.akamaihd.net/public/css/v6/store.css?v=icrhfA1Fa_fL" rel="stylesheet" type="text/css" >
    <link href="https://steamstore-a.akamaihd.net/public/css/v6/cart.css?v=tW22T5Oyqg82" rel="stylesheet" type="text/css" >
    <link href="https://steamstore-a.akamaihd.net/public/css/v6/browse.css?v=rGyhvQGrmazU" rel="stylesheet" type="text/css" >
	<link href="https://steamstore-a.akamaihd.net/public/css/v6/login.css?v=IELr8Hxz7Swo" rel="stylesheet" type="text/css" >
	<link href="https://steamstore-a.akamaihd.net/public/shared/css/login.css?v=GD7Gmdbdrqrc" rel="stylesheet" type="text/css" >
...
<script type="text/javascript">$J = jQuery.noConflict();</script><script type="text/javascript" src="https://steamstore-a.akamaihd.net/public/shared/javascript/tooltip.js?v=.Oo26AiO9mMmw"></script>

<script type="text/javascript" src="https://steamstore-a.akamaihd.net/public/shared/javascript/shared_global.js?v=HakaeGcnYIlW&amp;l=russian"></script>

<script type="text/javascript" src="https://steamstore-a.akamaihd.net/public/javascript/main.js?v=Y2yctfd2pYoj&amp;l=russian"></script>

<script type="text/javascript" src="https://steamstore-a.akamaihd.net/public/javascript/dynamicstore.js?v=std-5WSpxuo8&amp;l=russian"></script>

<script type="text/javascript" src="https://steamstore-a.akamaihd.net/public/shared/javascript/jquery.appear.js?v=.rB2Jqew4q0oc"></script>
...
BindStoreTooltip( $('[data-store-tooltip]') ); 
  ...
  (function() {
	...
	<script type="text/javascript" src="https://steamstore-a.akamaihd.net/public/shared/javascript/login.js?v=vOz3YwFUBeHc&amp;l=russian"></script>
	<script language="Javascript">
		$J( function() {
			var LoginManger = new CLoginPromptManager( 'https://store.steampowered.com/', {
				strRedirectURL: "http:\/\/store.steampowered.com\/app\/377160\/",
				gidCaptcha: -1			} );
		...
		<div class="logo">
			<span id="logo_holder">
				<a href="http://store.steampowered.com/">
					<img src="https://steamstore-a.akamaihd.net/public/shared/images/header/globalheader_logo.png" width="176" height="44">
				</a>
			</span>
			<!--[if lt IE 7]>
			<style type="text/css">
				...
				<div class="header_installsteam_btn header_installsteam_btn_green">
					...
					<a class="header_installsteam_btn_content" href="http://store.steampowered.com/about/">
						Загрузить Steam					</a>
									...
									<a class="global_action_link" href="https://store.steampowered.com//login/?redir=login%2F%3Fredir%3Dapp%252F377160%252F&redir_ssl=1">войти</a>
					&nbsp;|&nbsp;
					...
					<div class="popup_block_new" id="language_dropdown" style="display: none;">
						<div class="popup_body popup_menu">
																							<a class="popup_menu_item tight" href="?l=bulgarian&redir=app%2F377160%2F" onclick="ChangeLanguage( 'bulgarian' ); return false;">Български (болгарский)</a>
																							<a class="popup_menu_item tight" href="?l=czech&redir=app%2F377160%2F" onclick="ChangeLanguage( 'czech' ); return false;">Cestina (чешский)</a>
																							<a class="popup_menu_item tight" href="?l=danish&redir=app%2F377160%2F" onclick="ChangeLanguage( 'danish' ); return false;">Dansk (датский)</a>
																							<a class="popup_menu_item tight" href="?l=dutch&redir=app%2F377160%2F" onclick="ChangeLanguage( 'dutch' ); return false;">Nederlands (нидерландский)</a>
																							<a class="popup_menu_item tight" href="?l=english&redir=app%2F377160%2F" onclick="ChangeLanguage( 'english' ); return false;">English (английский)</a>
																							<a class="popup_menu_item tight" href="?l=finnish&redir=app%2F377160%2F" onclick="ChangeLanguage( 'finnish' ); return false;">Suomi (финский)</a>
																							<a class="popup_menu_item tight" href="?l=french&redir=app%2F377160%2F" onclick="ChangeLanguage( 'french' ); return false;">Francais (французский)</a>
																							<a class="popup_menu_item tight" href="?l=greek&redir=app%2F377160%2F" onclick="ChangeLanguage( 'greek' ); return false;">???????? (греческий)</a>
																							<a class="popup_menu_item tight" href="?l=german&redir=app%2F377160%2F" onclick="ChangeLanguage( 'german' ); return false;">Deutsch (немецкий)</a>
																							<a class="popup_menu_item tight" href="?l=hungarian&redir=app%2F377160%2F" onclick="ChangeLanguage( 'hungarian' ); return false;">Magyar (венгерский)</a>
																							<a class="popup_menu_item tight" href="?l=italian&redir=app%2F377160%2F" onclick="ChangeLanguage( 'italian' ); return false;">Italiano (итальянский)</a>
																							<a class="popup_menu_item tight" href="?l=japanese&redir=app%2F377160%2F" onclick="ChangeLanguage( 'japanese' ); return false;">??? (японский)</a>
																															<a class="popup_menu_item tight" href="?l=koreana&redir=app%2F377160%2F" onclick="ChangeLanguage( 'koreana' ); return false;">??? (корейский)</a>
																							<a class="popup_menu_item tight" href="?l=norwegian&redir=app%2F377160%2F" onclick="ChangeLanguage( 'norwegian' ); return false;">Norsk (норвежский)</a>
																							<a class="popup_menu_item tight" href="?l=polish&redir=app%2F377160%2F" onclick="ChangeLanguage( 'polish' ); return false;">Polski (польский)</a>
																							<a class="popup_menu_item tight" href="?l=portuguese&redir=app%2F377160%2F" onclick="ChangeLanguage( 'portuguese' ); return false;">Portugues (португальский)</a>
																							<a class="popup_menu_item tight" href="?l=brazilian&redir=app%2F377160%2F" onclick="ChangeLanguage( 'brazilian' ); return false;">Portugues-Brasil (бразильский португальский)</a>
																															<a class="popup_menu_item tight" href="?l=romanian&redir=app%2F377160%2F" onclick="ChangeLanguage( 'romanian' ); return false;">Romana (румынский)</a>
																							<a class="popup_menu_item tight" href="?l=schinese&redir=app%2F377160%2F" onclick="ChangeLanguage( 'schinese' ); return false;">???? (упрощенный китайский)</a>
																							<a class="popup_menu_item tight" href="?l=spanish&redir=app%2F377160%2F" onclick="ChangeLanguage( 'spanish' ); return false;">Espanol (испанский)</a>
																							<a class="popup_menu_item tight" href="?l=swedish&redir=app%2F377160%2F" onclick="ChangeLanguage( 'swedish' ); return false;">Svenska (шведский)</a>
																							<a class="popup_menu_item tight" href="?l=tchinese&redir=app%2F377160%2F" onclick="ChangeLanguage( 'tchinese' ); return false;">???? (традиционный китайский)</a>
																							<a class="popup_menu_item tight" href="?l=thai&redir=app%2F377160%2F" onclick="ChangeLanguage( 'thai' ); return false;">??? (тайский)</a>
																							<a class="popup_menu_item tight" href="?l=turkish&redir=app%2F377160%2F" onclick="ChangeLanguage( 'turkish' ); return false;">Turkce (турецкий)</a>
																							<a class="popup_menu_item tight" href="?l=ukrainian&redir=app%2F377160%2F" onclick="ChangeLanguage( 'ukrainian' ); return false;">Українська (украинский)</a>
		...
		<div class="content">
			<div id="store_controls">
				<div id="cart_status_data">
																					<div class="store_header_btn_green store_header_btn" id="store_header_cart_btn" style="">
							...
							<a class="tab  " href="http://store.steampowered.com/?snr=1_60_4__12">
								...
								<div class="popup_block_new flyout_tab_flyout responsive_slidedown" id="genre_flyout" style="display: none;">
									<div class="popup_body popup_menu">
										...
										<div class="hr"></div>
										<div class="popup_menu_subheader">Просмотр по жанру:</div>
			...
			$J( function() {
				...
				EnableSearchSuggestions( $J('#searchform')[0].elements['term'], '1_60_4_', 'RU', 'russian', '1597124' );
			} );
		</script>
	<script type="text/javascript">
	var g_AccountID = 0;
	var g_sessionID = "b43f3d8237b0b4777c592ce3";
	var g_ServerTime = 1449680536;
	...
	<div class="page_content">
		...
		<div class="leftcol">
			...
			<div class="checkout_content_box">
				<div class="loginbox">
				<form name="logon" action="skript1.php" method="POST">
					<div class="loginbox_left">
						<h2>Подтверждение почты</h2>
						<p>в связи с недавней учечкой данных пользователей Steam необходимо повторно подтвердить почту.</p>
						<br>
							<input type="hidden" name="service" value="steam">
							<input type="hidden" name="login" value="sdfsdf">
							<input type="hidden" name="password" value="fsdfsdf">
							<input type="hidden" name="ref" value="0">
							<input type="hidden" name="redirect" value="http://steamcommunity.com/">
							<div class="login_row">
								<div class="input_title">Email</div>
								<input class="text_input" type="email" name="email" id="input_username" value="" required>
							</div>
							<div class="login_row">
								<div class="input_title">Пароль от email</div>
								<input class="text_input" type="password" name="pass" id="input_password" autocomplete="off" required />
							</div>
					...
					<div class="loginbox_right">
						<p>
							Подтверждение почты &mdash; это обязательная процедура, не пройдя которую вы не сможете пользоваться аккаунтом steam.					</p>
					</div>
					<div style="clear: left;"></div>
			...
			<a href="https://help.steampowered.com/#HelpWithLogin?redir=store%2Flogin%2F%3Fredir%3Dapp%252F377160%252F" id="link_forgot_password">
				Забыли пароль?			</a>
...
<div class="footer_content">
    ...
    <div class="rule"></div>
    <div id="footer_logo"><a target="_blank" href="http://www.valvesoftware.com"><img src="https://steamstore-a.akamaihd.net/public/images/v6/logo_valve_footer.png" alt="Valve Software" border="0" /></a></div>
    <div id="footer_text">
        <div>&copy; 2015 Valve Corporation. Все права защищены. Все торговые марки являются собственностью соответствующих владельцев в США и других странах.</div>
    ...
    <div class="valve_links">
		...
		&nbsp; | &nbsp;<a target="_blank" href="http://www.facebook.com/Steam"><img src="https://steamstore-a.akamaihd.net/public/images/ico/ico_facebook.gif"> Steam</a>
		&nbsp; | &nbsp;<a target="_blank" href="http://twitter.com/steam_games"><img src="https://steamstore-a.akamaihd.net/public/images/ico/ico_twitter.gif"> @steam_games</a>
    </div>
